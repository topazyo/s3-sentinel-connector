...
class DataValidator:
        ...
        for rule in rules:
            ...
            if error:
                if rule.field not in errors:
                    errors[rule.field] = []
                errors[rule.field].append(rule.error_message or error)

        return errors

    def _validate_required(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
        """Validate required field"""
        if value is None or (isinstance(value, str) and not value.strip()):
            return "Field is required"
        return None

    def _validate_type(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
        """Validate value type"""
        if value is None:
            return None
    ...
    def _validate_regex(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
    ...
    def _validate_range(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
    ...
    def _validate_enum(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
    ...
    def _validate_ip(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
        """Validate IP address"""
        if not value:
            return None
    ...
    def _validate_timestamp(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
        """Validate timestamp"""
        if not value:
            return None
    ...
    def _validate_length(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
    ...
    def _validate_custom(self, value: Any, params: Dict[str, Any]) -> Optional[str]:
        ...
        try:
            ...
            return f"Custom validation error: {e!s}"
