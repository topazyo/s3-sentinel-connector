...
def mock_s3_bucket(mock_aws_credentials):
    ...
    with mock_s3():
        ...
        test_logs = [
            (
                "logs/firewall/2024/02/20/log1.json",
                b'{"src_ip": "192.168.1.1", "dst_ip": "10.0.0.1", "action": "allow"}',
            ),
            (
                "logs/firewall/2024/02/20/log2.json",
                b'{"src_ip": "192.168.1.2", "dst_ip": "10.0.0.2", "action": "deny"}',
            ),
        ]
...
def s3_handler(mock_aws_credentials):
    ...
    return S3Handler(
        aws_access_key="testing", aws_secret_key="testing", region="us-east-1"
    )
