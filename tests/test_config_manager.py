...
class TestConfigManager:
    ...
    def test_config_path(self, tmp_path):
        ...
        # Create base config
        base_config = {
            "aws": {"region": "us-east-1", "batch_size": 1000},
            "sentinel": {"workspace_id": "base-workspace", "retention_days": 90},
        }
        ...
        test_config = {
            ...
            "sentinel": {"workspace_id": "test-workspace"},
        }
    ...
    async def test_reload_config(self, test_config_path):
        ...
        # Modify config file
        test_config = {"aws": {"bucket_name": "updated-bucket"}}
