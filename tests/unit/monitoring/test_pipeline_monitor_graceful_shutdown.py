...
from src.monitoring.pipeline_monitor import AlertConfig, PipelineMonitor
...
def mock_azure_clients():
    ...
    with (
        patch("src.monitoring.pipeline_monitor.MetricsIngestionClient") as mock_metrics,
...
class TestHealthCheckLoopGracefulShutdown:
    ...
    async def test_health_check_loop_handles_cancellation(self, pipeline_monitor):
        ...
        pipeline_monitor._check_sentinel_health = AsyncMock(
