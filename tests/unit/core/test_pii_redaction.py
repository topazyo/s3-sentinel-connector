...
class TestPIIRedaction:
    ...
    def test_redact_ssn(self, sentinel_router):
        """Test SSN redaction"""
        record = {"ssn": "123-45-6789", "notes": "SSN: 987-65-4321"}
    ...
    def test_redact_credit_card_numbers(self, sentinel_router):
        ...
        record = {"payment": "4532-1234-5678-9010", "card": "4532123456789010"}
    ...
    def test_redact_ipv4_addresses(self, sentinel_router):
        ...
        record = {"source_ip": "192.168.1.100", "dest_ip": "10.0.0.50"}
    ...
    def test_redact_api_keys(self, sentinel_router):
        ...
        record = {"api_key": "sk_live_" + sk_suffix, "token": "ghp_" + ghp_suffix}
    ...
    def test_redact_by_field_name_password(self, sentinel_router):
        ...
        record = {"password": "secret123", "user_password": "mypass", "pwd": "hidden"}
    ...
    def test_mixed_pii_in_single_field(self, sentinel_router):
        ...
        record = {"notes": "Contact John at john@example.com or 555-123-4567"}
    ...
    def test_none_values_preserved(self, sentinel_router):
        ...
        record = {"field1": None, "field2": "value", "email": None}
    ...
    def test_deep_copy_original_unmodified(self, sentinel_router):
        ...
        original = {"email": "test@example.com", "password": "secret123"}
        ...
        record = {
            "metadata": {
                "user": {
                    ...
                    "profile": {"phone": "555-9999", "ssn": "111-22-3333"},
                },
                "contacts": [
