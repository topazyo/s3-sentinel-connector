...
from src.core.sentinel_router import TableConfig
...
class TestSentinelRouter:
    ...
    async def test_prepare_log_entry(self, sentinel_router, table_config):
        ...
        log = {"src_ip": "192.168.1.1", "dst_ip": "10.0.0.1", "action": "allow"}

        prepared_log = sentinel_router._prepare_log_entry(log, table_config, "standard")
